(()=>{var yr=class{async get(t){let n=await fetch(t,{method:"GET"});return this.handleResponse(n)}async post(t,n,r,o){let i=await fetch(t,{method:"POST",headers:n,body:r,signal:o});return this.handleResponse(i)}async handleResponse(t){let n=await t.json();if(!t.ok)throw new Error(t.statusText);return n}},Si=new yr;var g=typeof __SENTRY_DEBUG__>"u"||__SENTRY_DEBUG__;var S=globalThis;var Be="9.38.0";function ie(){return ut(S),S}function ut(e){let t=e.__SENTRY__=e.__SENTRY__||{};return t.version=t.version||Be,t[Be]=t[Be]||{}}function pt(e,t,n=S){let r=n.__SENTRY__=n.__SENTRY__||{},o=r[Be]=r[Be]||{};return o[e]||(o[e]=t())}var br=["debug","info","warn","error","log","assert","trace"],sc="Sentry Logger ",vt={};function pe(e){if(!("console"in S))return e();let t=S.console,n={},r=Object.keys(vt);r.forEach(o=>{let i=vt[o];n[o]=t[o],t[o]=i});try{return e()}finally{r.forEach(o=>{t[o]=n[o]})}}function hi(){Ar().enabled=!0}function Ei(){Ar().enabled=!1}function Rr(){return Ar().enabled}function Ti(...e){dt("log",...e)}function ac(...e){dt("info",...e)}function Ii(...e){dt("warn",...e)}function yi(...e){dt("error",...e)}function cc(...e){dt("debug",...e)}function uc(...e){dt("assert",...e)}function pc(...e){dt("trace",...e)}function dt(e,...t){g&&Rr()&&pe(()=>{S.console[e](`${sc}[${e}]:`,...t)})}function Ar(){return g?pt("loggerSettings",()=>({enabled:!1})):{enabled:!1}}var O={enable:hi,disable:Ei,isEnabled:Rr,log:Ti,info:ac,warn:Ii,error:yi,debug:cc,assert:uc,trace:pc},l={enable:hi,disable:Ei,isEnabled:Rr,log:Ti,warn:Ii,error:yi};var Ne="?",bi=/\(error: (.*)\)/,Ri=/captureMessage|captureException/;function En(...e){let t=e.sort((n,r)=>n[0]-r[0]).map(n=>n[1]);return(n,r=0,o=0)=>{let i=[],s=n.split(`
